...
-define(EFF,0.00001). %Efficiency., TODO: this should further be changed from absolute number of neurons, to diff in lowest or avg, and the highest number of neurons
		...
		uniquify(ProperlySorted_DXSummaries,TotSurvivors)->
			...
			diversify(_TopProfiles,[],KeepTot,Acc)->
				...
				compare_profilesf([{TopFitness,TopProfile}|TopProfiles],{Fitness,Profile})->%Better make Fitnes part of profile
					case (TopProfile == Profile) and (TopFitness == Fitness) of
						true ->
							false;
						false ->
